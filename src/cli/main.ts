...
import { ObfuscatorEngine, applyIntensity } from "../obfuscator.js";
...
function loadConfig(configPath?: string): Partial<ObfuscationConfig> {
...
function runObfuscator(inputPath: string, options: any): void {
  ...
  const config: Partial<ObfuscationConfig> = {
